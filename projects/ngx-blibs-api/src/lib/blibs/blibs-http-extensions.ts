import { IBlibsTableState } from '../blibs_models/blibs-table-response.model';

export function baseFilter(entities: any[], requestObj: IBlibsTableState) {
    // Filtration
...
export function filterArray(incomingArray: any[], requestObj: IBlibsTableState): any[] {
